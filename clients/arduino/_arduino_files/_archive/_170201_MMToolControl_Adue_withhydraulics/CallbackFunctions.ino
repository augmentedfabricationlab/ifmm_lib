...
// callback functions =====================================================
void cb_set_do_old(long do_state[2]) { // set digital output: do_state[0] = do_num, do_state[1] = do_state
  Serial.print("set_do: ");
...
void cb_set_do(long do_state[2]) { // set digital output: do_state[0] = do_num, do_state[1] = do_state
  ...
  /*if (do_state[1] == true){
        ...
        noInterrupts();
        bool ok = mm_hydraulics_control.Close();
        interrupts();
    
    }else{
        noInterrupts();
        bool ok = mm_hydraulics_control.Open();
        interrupts();
      } */

...
offset_lead_out = 45
#lead_out_top = 2500 + discrete_insertion_offset + 30
offset_lead_out_z = 100
offset_to_plinth = 386


class MMFabMeshRoboBendFW(MMMesh):
    ...
    def generate_nodes_in_layers(self, row_from, row_to):
        ...
        return zip(nodes_in_row_srf2, nodes_in_row_srf1) if self.srf_rev == False else zip(nodes_in_row_srf1, nodes_in_row_srf2)
    ...
    def generate_nodes_exterior_lead_out(self, row, index_row, node_type, srf, layer_type, index_layer_list):
        ...
        if layer_type == "even": 
            plane_wrist_1.Translate(plane_wrist_1.XAxis * (offset_lead_out + discrete_insertion_offset))
        else:

...
class Node:
    ...
    def __init__(self, node_type, layer_type, index_row, index_layer_list):
        ...
        self.wrist_plane_for_bending = None # is also the plane to drive to, if no discrete element is inserted
        self.wrist_plane_for_inserting = None  
        ...
        # for testing bending with the robot
        self.robo_plane_before_bending = None
        self.robo_plane_after_bending = None
    ...
    def fill_params(self, wrist_plane_for_bending, axis = None, insert_discrete_element = False, wrist_plane_for_inserting = None, wrist_plane_for_inserting_tilted = None, line_discrete_element = None, intersect_line_cont_disc = None):    
                    
        self.wrist_plane_for_bending = wrist_plane_for_bending
        self.axis = axis
        self.insert_discrete_element = insert_discrete_element
        self.wrist_plane_for_inserting = wrist_plane_for_inserting  
        self.wrist_plane_for_inserting_tilted = wrist_plane_for_inserting_tilted

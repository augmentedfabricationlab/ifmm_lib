...
class Frame():
    ...
    def get_axes_as_lines_and_colors(self):
        ''' this method allows you to visualize the tool axes as lines and gh colors '''
        
        axes = self.get_axes_as_lines(length=100)
        axes_colors = [ghcomp.ColourRGB(255, 255, 0, 0), ghcomp.ColourRGB(255, 0, 255, 0), ghcomp.ColourRGB(255, 0, 0, 255)]

        return axes, axes_colors
